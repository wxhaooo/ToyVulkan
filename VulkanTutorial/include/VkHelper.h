...
namespace __VkHelper
{
	...
	inline void __CheckVulkanResult(const VkResult vkResult, const char* file, const int line)
	{
...
#define CheckVulkanResult(result) __VkHelper::__CheckVulkanResult(result, __FILE__, __LINE__)