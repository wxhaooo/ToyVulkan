...
public:
	...
	void CreateGraphicsPipeline()
	{
		...
		std::string vertShader = workingPath + "/resource/shaders/drawTriangleVertShader.spv";
		std::string fragShader = workingPath + "/resource/shaders/drawTriangleFragShader.spv";
