...
void DeferredPBR::BakingIrradianceCubeMap()
{
    ...
    const std::vector<VkVertexInputAttributeDescription> vertexInputAttributes = {
        ...
        vks::initializers::VertexInputAttributeDescription(0, 1, VK_FORMAT_R32G32B32_SFLOAT,
                                                           offsetof(vks::geometry::VulkanGLTFModel::Vertex, normal)),
        // Location 1: Normal
...
void DeferredPBR::BakingPreFilteringCubeMap()
{
    ...
    std::array<VkPipelineShaderStageCreateInfo, 2> shaderStages =
    {
        LoadShader(vks::helper::GetShaderBasePath() + "deferred/filtercube.vert.spv", VK_SHADER_STAGE_VERTEX_BIT),
...
void DeferredPBR::PrepareMrtPipeline()
{
    ...
    const std::vector<VkVertexInputAttributeDescription> vertexInputAttributes = {
        ...
        vks::initializers::VertexInputAttributeDescription(0, 4, VK_FORMAT_R32G32B32A32_SFLOAT,
                                                           offsetof(vks::geometry::VulkanGLTFModel::Vertex, tangent)),
        // Location 4: Tangent
    };
    VkPipelineVertexInputStateCreateInfo vertexInputStateCI = vks::initializers::PipelineVertexInputStateCreateInfo();
    vertexInputStateCI.vertexBindingDescriptionCount = static_cast<uint32_t>(vertexInputBindings.size());
    ...
    if (deviceFeatures.fillModeNonSolid)
    {
        ...
        CheckVulkanResult(
            vkCreateGraphicsPipelines(device, pipelineCache, 1, &pipelineCI, nullptr, &pipelines.offscreenWireframe));
    }
}
